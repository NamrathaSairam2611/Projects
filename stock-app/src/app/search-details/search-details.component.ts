...
>>>>>>> parent of bb3ad2b (Assignment 3 changes deployed)
  ...
  getPortfolios() {
    this.stockService?.getPortfolio().subscribe((data: any) => {
...
<<<<<<< HEAD
    if (this.portfolios?.some((item: any) => item.symbol === this.symbol)) {
      this.getSellQuantity(this.symbol);
    }
...
>>>>>>> parent of bb3ad2b (Assignment 3 changes deployed)
    ...
    // apiObservables.push(this.stockService?.getCompanyData(this.symbol));
    ...
    forkJoin(apiObservables).subscribe(
      (results: any[]) => {
        ...
        console.log('the insider sentiments is', this.insiderSentimentsData);
        this.cacheData = {
          ...this.cacheData,
        ...
        console.log('The results are ', results[3]);
        console.log('The ts is', this.chartsData);
        this.cacheData = {
          ...this.cacheData,
        ...
        console.log('The us', this.cacheData);
